...
d3.csv(csvFilePath).then((data) => {
  ...
  var legend1 = FRAME1.append("text").attr("x", 120).attr("y", 80).text("Player1").style("font-size", "15px").attr("alignment-baseline", "middle")
  var legend2 = FRAME1.append("text").attr("x", 120).attr("y", 110).text("Player2").style("font-size", "15px").attr("alignment-baseline", "middle")
  const xMarklegend = FRAME1.append("g")
    .attr("class", "x-mark");

  xMarklegend.append("line")
    .attr("x1", -5)
    .attr("y1", -5)
    .attr("x2", 5)
    .attr("y2", 5)
  ...
  xMarklegend.attr("transform", `translate(100, 140)`);
  FRAME1.append("text").attr("x", 120).attr("y", 140).text("reached mlb").style("font-size", "15px").attr("alignment-baseline", "middle")
  ...
  function onMouseMove() {
    ...
    tooltip1.html("Year:" + act_year + ", Risk:" + act_p1).style("left", (xScale1(act_year) + MARGINS.left) + "px") //add offset from mouse
      .style("top", (yScale1(act_p1) + 350) + "px");
  ...
  const xMarklegendre = FRAME2.append("g")
    .attr("class", "x-mark");

  xMarklegendre.append("line")
    .attr("x1", -5)
    .attr("y1", -5)
    .attr("x2", 5)
    .attr("y2", 5)
  ...
  xMarklegendre.attr("transform", `translate(100, 140)`);

  FRAME2.append("text").attr("x", 120).attr("y", 140).text("retired without reached mlb").style("font-size", "15px").attr("alignment-baseline", "middle")
  ...
  var legend3 = FRAME2.append("text").attr("x", 120).attr("y", 80).text("Player1").style("font-size", "15px").attr("alignment-baseline", "middle")
  var legend4 = FRAME2.append("text").attr("x", 120).attr("y", 110).text("Player2").style("font-size", "15px").attr("alignment-baseline", "middle")
  ...
  // update legends
  function update_byname() {
    var selectplayer1 = document.getElementById('name_dropdown1');
    var selectplayer2 = document.getElementById('name_dropdown2');
    var name1 = selectplayer1.value;
    var name2 = selectplayer2.value;
    legend1.text(name1);
    legend2.text(name2);
    legend3.text(name1);
    legend4.text(name2);
  ...
  document.getElementById('name_dropdown1').onchange = update_byname;
  document.getElementById('name_dropdown2').onchange = update_byname;
